...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    private String[] permissõesNecessárias = new String[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identificadorUsuario = UsuarioFirebase.getUsuarioIdentificador();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if ( resultCode == RESULT_OK){
            ...
            try {
                ...
                switch ( requestCode ){
                    case SELECAO_CAMERA:    imagem = (Bitmap) data.getExtras().get("data");
                                            break;

                    case SELECAO_GALERIA:   Uri localImagemSelecionada = data.getData();
